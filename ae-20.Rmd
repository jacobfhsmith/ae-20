...
- Lab due on Weds November 3
- Election Day: If you are a NC registered voter, polls are open from 6:30 PM to 7:30 PM! 
...
2. How popular are candies that have caramel? Run a linear model with caramel as the explanatory variable and win percentage as the response variable and interpret it.
...
3. Which candy is the sweetest: chocolate, caramel, candies with both, or candies with neither? Create a variable that represents this using `case_when` and then run and interpret a linear model with sugar content as the dependent variable.
